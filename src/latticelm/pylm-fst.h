...
public:
  PylmFst(Pylm & pylm) : pylm_(&pylm), 
                               properties_(fst::kExpanded | fst::kAcceptor | fst::kIDeterministic | fst::kODeterministic | fst::kILabelSorted | fst::kOLabelSorted | fst::kWeighted | fst::kCyclic),
                               type_("pylm"),
  ...
  virtual uint64 Properties(uint64 mask, bool test) const override { cerr << "PylmFst::Properties() == " << properties_ << endl; return properties_; };
